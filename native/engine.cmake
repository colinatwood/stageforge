...
if(STAGEFORGE_BUILD_TESTS)
    ...
    add_executable(stageforge_midi_mapping_e2e_smoke tests/midi_mapping_e2e_smoke.cpp)
    target_link_libraries(stageforge_midi_mapping_e2e_smoke PRIVATE stageforge_core)
    target_compile_features(stageforge_midi_mapping_e2e_smoke PRIVATE cxx_std_20)
    if(MSVC)
        target_compile_options(stageforge_midi_mapping_e2e_smoke PRIVATE /W4 /permissive-)
    else()
        target_compile_options(stageforge_midi_mapping_e2e_smoke PRIVATE -Wall -Wextra -Wpedantic)
    endif()
    add_test(NAME stageforge_midi_mapping_e2e_smoke COMMAND stageforge_midi_mapping_e2e_smoke)
